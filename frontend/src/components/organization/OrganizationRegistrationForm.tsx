...
//   const sectionTitle =
//     "flex items-center gap-2 text-sm font-semibold text-blue-600 mb-3";
...
//             />
//             {errors.addressLine && (
//               <p className={errorText}>{errors.addressLine}</p>
//             )}
//           </div>
...
//       <button
//         type="submit"
//         className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white py-3 md:py-3.5 text-sm md:text-base rounded-lg font-semibold hover:opacity-90 transition"
//       >
//         Register
//       </button>
//     </form>
