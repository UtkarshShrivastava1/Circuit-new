...
>>>>>>> origin/Ritika
  ...
  const mutation = useMutation({
    mutationFn: (newData: Partial<Case>) =>
      createCase(auth.slug || "default-tenant", newData),
  ...
  const onSubmit = async (data: CaseFormValues) => {
    ...
    mutation.mutate({
      ...data,
      caseNumber: `CASE-${new Date().getFullYear()}-${Math.floor(
        Math.random() * 10000,
      )
        .toString()
        .padStart(5, "0")}`,
        ...
        <div>
          ...
          <div className="text-[13px] text-base-content/60 mt-1 font-medium min-w-0">
            <ul className="flex flex-wrap items-center min-w-0">
              ...
              <li className="whitespace-normal">Cases</li>
              <span className="mx-2 text-base-content/40">›</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <label className="label py-1">
                    <span className="label-text font-medium">Case Number</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    {...register("subject")}
                    className={`input input-sm input-bordered w-full ${errors.subject ? "input-error" : ""}`}
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className={`textarea textarea-sm textarea-bordered w-full  ${errors.description ? "textarea-error" : ""}`}
                    rows={5}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register("customer")}
                    type="text"
                    className={`input input-sm input-bordered w-full ${errors.customer ? "input-error" : ""}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="dropdown w-full">
                    <label
                      tabIndex={0}
                      className="btn btn-sm btn-outline bg-base-100 justify-start font-normal w-full border-base-300"
                    >
                      {wAssignee || "-Select Representative-"}
                    </label>
                    <div
                      tabIndex={0}
                    ...
                    >
                      ...
                      <ul className="max-h-60 overflow-y-auto">
                        {filteredReps.map((rep: string) => (
                          <li key={rep}>
                            <a
                              onClick={() => {
                                setValue("assignedRep", rep);
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Initial thoughts or proposed resolution..."
                  ></textarea>
                </div>
              </div>
            </div>
          ...
          <div className="bg-base-100 border border-base-300 rounded-xl p-5 sticky top-24 shadow-sm">
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <div className="mt-1">
                  <div
                    className={`badge ${wPriority === "Critical" ? "badge-error text-white" : wPriority === "High" ? "badge-warning" : "badge-info text-white"} badge-sm font-bold`}
                  >
                    {wPriority || "Medium"}
                  </div>
                </div>
