...
export default function NewAccountForm() {
  ...
  const selectedOwner = salesReps.find(
    (rep: any) => rep.memberId?._id === wOwner,
  );
            ...
            <div className="collapse-content pt-5 space-y-4">
              ...
              >
                <select
                  ...
                  className={`select select-bordered w-full ${errors.accountOwner ? "select-error" : ""}`}
                >
                  <option value="">-Select Owner-</option>
                  {salesReps.map((rep: any) => (
                    <option key={rep.memberId?._id} value={rep.memberId?._id}>
                      {rep.memberId?.name}
                    </option>
                  ))}
                </select>
      ...
      e.target.value = e.target.value.replace(/\D/g, "").slice(0, 10);
          ...
          <div className="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl shadow-sm">
            ...
            <div className="collapse-content pt-5 space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-primary uppercase text-xs tracking-wider border-b border-base-200 pb-1 mb-2">
                  Billing Address
                </h4>
                <FormRow
                ...
                >
                  <input
                    ...
                    className={`input input-bordered w-full ${errors.billingAddress1 ? "input-error" : ""}`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <input
                      ...
                      className={`input input-bordered w-full ${errors.billingCity ? "input-error" : ""}`}
                    />
                  </FormRow>
                  <FormRow
                    label="State"
                  ...
                  >
                    <input
                      ...
                      className={`input input-bordered w-full ${errors.billingState ? "input-error" : ""}`}
                    />
                  </FormRow>
                  <FormRow
                    label="Postal Code"
                    required
                    error={errors.billingPostal?.message}
                  >
                    <input
                      {...register("billingPostal")}
                      className={`input input-bordered w-full ${errors.billingPostal ? "input-error" : ""}`}
                    />
                  </FormRow>
                  <FormRow
                    label="Country"
                  ...
                  >
                    <select
                      ...
                      className={`select select-bordered w-full ${errors.billingCountry ? "select-error" : ""}`}
                    >
              ...
              <div className="space-y-4 pt-4 border-t border-base-200">
                <div className="flex justify-between items-center mb-2 border-b border-base-200 pb-1">
                  <h4 className="font-semibold text-primary uppercase text-xs tracking-wider">
                    Shipping Address
                  </h4>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-base-100 border border-base-300 rounded-xl p-5 sticky top-24 shadow-sm">
            <h3 className="font-bold text-lg mb-4 pb-2 border-b border-base-200 flex items-center gap-2">
              <MdBusiness /> Summary
            </h3>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <div className="mt-1 flex gap-2">
                  ...
                  {wIndustry && (
                    <div className="badge badge-outline">{wIndustry}</div>
                  )}
                </div>
              </div>
