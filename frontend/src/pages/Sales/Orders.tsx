...
const MOCK_CUSTOMERS = [
  {
    ...
    billing: "123 Tech Park, Bangalore",
    shipping: "123 Tech Park, Bangalore",
  },
  {
    id: "CUST-002",
    name: "Acme Corp",
    ...
    phone: "+1 555-0198",
    email: "bob@acme.com",
    billing: "456 Corporate Blvd, NY",
    shipping: "789 Warehouse St, NY",
  },
];
  ...
  const format = (n: number): string => {
    ...
    if (n < 100000)
      return (
        ...
        "Thousand " +
        (n % 1000 !== 0 ? format(n % 1000) : "")
      );
    if (n < 10000000)
      return (
        format(Math.floor(n / 100000)) +
        "Lakh " +
        (n % 100000 !== 0 ? format(n % 100000) : "")
      );
    return (
      format(Math.floor(n / 10000000)) +
      "Crore " +
      (n % 10000000 !== 0 ? format(n % 10000000) : "")
    );
  };
...
export default function NewOrderForm() {
            ...
            reset({
              ...
              items:
                o.products?.map((p) => ({
                  ...
                  sku: p.sku || "",
                  stock:
                    products.find((mp) => mp.id === p.productId)
                      ?.stockQuantity || 999,
                  retailPrice: p.price,
  ...
  const handleProductChange = (index: any, e: any) => {
    ...
    if (product) {
      ...
      setValue(`items.${index}.retailPrice`, product.sellingPrice || 0);

      setValue(`items.${index}.costPrice`, product.costPrice || 0);
          ...
          <div className="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl">
            ...
            <div className="collapse-content pt-5 space-y-4">
              ...
              <FormRow
                label="Sales Owner"
                required
                error={errors.salesOwner?.message}
              >
                <div className="dropdown w-full">
                  <label
                    tabIndex={0}
                    className={`btn btn-sm btn-outline bg-base-100 justify-start font-normal w-full ${errors.salesOwner ? "border-error" : "border-base-300"}`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <input
                    ...
                    className={`input input-sm input-bordered w-full ${errors.deliveryDate ? "input-error" : ""}`}
                  />
                </FormRow>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="collapse-content pt-5 space-y-4">
              ...
              >
                <div className="flex gap-2">
                  <select
                    className={`select select-sm select-bordered w-full ${errors.customerId ? "select-error" : ""}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                <div>
                  ...
                  <textarea
                    ...
                    className={`textarea textarea-sm textarea-bordered w-full ${errors.billingAddress ? "textarea-error" : ""}`}
                    rows={3}
                  ></textarea>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    disabled={wSameAsBilling}
                    className={`textarea textarea-sm textarea-bordered w-full ${errors.shippingAddress ? "textarea-error" : ""}`}
                    rows={3}
                  ></textarea>
              ...
              <table className="table table-sm w-full min-w-[1000px]">
                ...
                <tbody>
                  {fields.map((field, index) => {
                    ...
                    const base = sp * qty;
                    const afterDisc =
                      base - (base * (item.discountPct || 0)) / 100;
                    const lineTotal =
                      afterDisc + (afterDisc * (item.taxPct || 0)) / 100;
                    ...
                    return (
                      <React.Fragment key={field.id}>
                        <tr className="hover:bg-base-200/20 border-b border-base-200">
                          <td className="align-top pt-3 font-medium text-base-content/50">
                            {index + 1}
                          </td>
                          ...
                          <td className="align-top pt-3">
                            <div className="flex flex-col gap-0.5">
                              ...
                              <span
                                className={`text-[10px] ${stockWarning ? "text-error font-bold flex items-center gap-1" : "text-base-content/60"}`}
                              >
                                Stock: {item.stock || 0}{" "}
                                {stockWarning && <MdWarning size={12} />}
                              </span>
                            </div>
                          </td>
                          <td className="align-top pt-3">
                            ₹{item.retailPrice?.toLocaleString() || "0.00"}
                          </td>
                          <td className="align-top">
                            <input
                              type="number"
                            ...
                            {errors.items?.[index]?.sellingPrice && (
                              <p className="text-xs text-error mt-1">Req.</p>
                            )}
                          </td>
                          <td className="align-top">
                            <input
                              ...
                              className={`input input-sm input-bordered w-full ${stockWarning ? "input-error bg-error/10" : ""}`}
                            />
                          ...
                          <td className="align-top pt-3 font-semibold text-success">
                            ...
                            {item.productId && (
                              <p className="text-[10px] text-base-content/50 font-normal mt-1">
                          ...
                          <td className="align-top pt-2 text-right">
                            <div className="join">
                              ...
                              <button
                                ...
                                className="btn btn-xs btn-ghost text-error hover:bg-error hover:text-white join-item"
            ...
            <div className="collapse-content pt-5">
              <div className="flex flex-col md:flex-row justify-between gap-8">
                ...
                <div className="flex-1 bg-base-200/50 p-4 rounded-xl border border-base-200 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-primary font-medium mt-1 uppercase text-sm leading-relaxed">
                    {amountInWords}
                  </p>
                </div>
                ...
                <div className="flex-1 space-y-3 md:max-w-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <input
                      type="number"
                      step="0.01"
                      {...register("summaryDiscount")}
                      className="input input-sm input-bordered w-32 text-right"
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-base-content/70">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <input
                      ...
                      className={`input input-sm input-bordered w-32 text-right ${errors.shippingCharges ? "input-error" : ""}`}
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-base-content/70">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`input input-sm input-bordered w-full pl-8 ${errors.advancePayment ? "input-error" : ""}`}
                    />
                  </div>
                </FormRow>
                <FormRow label="Outstanding Amount">
                  <input
                    ...
                    className="input input-sm input-bordered w-full bg-base-200 font-bold text-error"
                    readOnly
                  />
                </FormRow>
              </div>
          ...
          <div className="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl">
            ...
            <div className="collapse-content pt-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                  ...
                  <textarea
                    ...
                    className="textarea textarea-sm textarea-bordered w-full bg-warning/5 border-warning/30"
                    rows={3}
                ...
                <div>
                  <label className="label text-sm font-medium">
                    <span className="label-text">Customer Notes</span>
                  </label>
                  <textarea
                    {...register("customerNotes")}
                    className="textarea textarea-sm textarea-bordered w-full"
                    rows={3}
                    placeholder="Printed on order/invoice..."
                  ></textarea>
                </div>
              </div>
              ...
              <div className="border-2 border-dashed border-base-300 rounded-xl p-6 text-center hover:bg-base-200/50 transition-colors">
                <MdAttachment
                  className="mx-auto text-base-content/40 mb-2"
                  size={32}
                />
              ...
              {attachments.length > 0 && (
                <ul className="mt-4 space-y-2">
                  {attachments.map((file, i) => (
                    <li
                      key={i}
                      className="flex justify-between items-center bg-base-200 px-4 py-2 rounded-md border border-base-300"
                    >
                ...
                {watch("requiresApproval") && (
                  <>
                    ...
                    <FormRow label="Approval Status">
                      <div className="badge badge-lg badge-outline badge-warning font-bold">
                        Pending
                      </div>
                    </FormRow>
                  </>
          ...
          <div className="bg-base-100 border border-base-300 rounded-xl p-5 sticky top-24 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="font-mono font-bold text-primary text-sm mt-1">
                  {watch("orderNumber")}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-bold text-success text-2xl mt-1">
                  ₹
                  {grandTotal.toLocaleString(undefined, {
                    maximumFractionDigits: 2,
                  })}
            ...
            <div className="mt-6 pt-4 border-t border-base-200 space-y-2">
              <button
                ...
                className="btn btn-primary w-full shadow-sm gap-2"
              >
                {isSubmitting ? (
                  <span className="loading loading-spinner loading-sm"></span>
                ) : (
                  <>
                    <MdSend size={18} /> Submit Order
                  </>
                )}
              </button>
            </div>
