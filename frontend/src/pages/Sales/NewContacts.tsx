  ...
  const onSubmit = async (data: ContactFormValues) => {
    ...
    try {
      const payload = {
        ...
        gender:
          data.gender && data.gender !== "-Select-" ? data.gender : undefined,
        ...
        leadSource:
          data.leadSource && data.leadSource !== "-Select Source-"
            ? data.leadSource
            : undefined,
        status: data.status,
        ...
        address: {
          ...
          country:
            data.address.country && data.address.country !== "-Select-"
              ? data.address.country
              : undefined,
        },
      };

      const response = await createContact(slug, payload);
          ...
          <div className="collapse collapse-arrow bg-base-100 border border-base-300 rounded-xl shadow-sm">
            ...
            <div className="collapse-content pt-5 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <input
                    type="email"
                    {...register("altEmail")}
                    className={`input input-bordered w-full ${errors.altEmail ? "input-error" : ""}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <div
                    className={`flex border rounded-lg overflow-hidden ${errors.phone?.number ? "border-error" : "border-base-300"} focus-within:border-primary transition-colors bg-base-100`}
                  >
                    <select
            ...
            <div className="collapse-content pt-5 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormRow
                  label="Assigned Rep"
                  required
                  error={errors.assignedRep?.message}
                >
                  <select
                    {...register("assignedRep")}
                    className={`select select-bordered w-full ${errors.assignedRep ? "select-error" : ""}`}
                  >
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium mt-1 truncate">
                  {" "}
                  {selectedOwner?.memberId?.name || "Unassigned"}
                </p>
              </div>
            </div>
