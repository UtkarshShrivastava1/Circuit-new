...
import { useAuth } from "../auth/AuthContext.tsx"; // ✅ use AuthContext
...
//       console.log("Calling AuthContext login with:", response.data.user, response.data.user.organization);
// authLogin({
//   user: response.data.user,
//   slug: response.data.user.organization,
// });
...
//         authLogin({
//           user: response.data.user,
//           slug: response.data.slug, // or whatever slug
//         });

//         // ✅ Optional: if parent wants token
//         if (setToken) {
//           setToken(response.data.token);
//         }
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (response.data && response.data.user && response.data.slug) {
      // Use the slug returned from backend
      authLogin({
        user: response.data.user,
